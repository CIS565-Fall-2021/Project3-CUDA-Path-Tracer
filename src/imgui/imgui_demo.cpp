  ...
  if (ImGui::CollapsingHeader("Configuration")) {
    ...
    if (ImGui::TreeNode("Backend Flags")) {
      HelpMarker(
          ...
          "specify their capabilities.\nHere we expose then as read-only "
          "fields to avoid breaking interactions with your back-end.");
  ...
  if (ImGui::TreeNode("Text")) {
    ...
    if (ImGui::TreeNode("UTF-8 Text")) {
      ...
      ImGui::TextWrapped(
          ...
          "ranges. Read docs/FONTS.txt for details.");
      ImGui::Text(
          "Hiragana: "
    ...
    if (ImGui::BeginTabItem("Colors")) {
      ...
      for (int i = 0; i < ImGuiCol_COUNT; i++) {
        ...
        if (memcmp(&style.Colors[i], &ref->Colors[i], sizeof(ImVec4)) != 0) {
          ...
          // use icons. Read the FAQ and docs/FONTS.txt about using icon fonts.
