...
bool utilityCore::epsilon_eq(float a, float b)
{
	return fabs(fabs(a) - fabs(b)) < EPSILON;
}

glm::mat4 utilityCore::make_transform_matrix(glm::vec3 translation, glm::vec3 rotation, glm::vec3 scale)
{
...
std::vector<std::string> utilityCore::tokenize_string(std::string str)
{
...
std::istream &utilityCore::safe_getline(std::istream &is, std::string &t)
{
